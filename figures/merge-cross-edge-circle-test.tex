...
\begin{tikzpicture}
  ...
  %\tkzCircumCenter(v0,v5,v8)\tkzGetPoint{M}
  %\tkzDrawCircle[invalid,dashed](M,v0)

  \tkzCircumCenter(v0,v5,v4)\tkzGetPoint{N}
  \tkzDrawCircle[dashed](N,v0)

  \tkzDrawSegments[invalid,dashed](v0,v8)
  \tkzDrawSegments[valid,dashed](v5,v4)
